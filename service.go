...
type httpEntrypoint struct {
	path       string
	method     string
	reqFactory func(echo.Context) interface{}
...
func WithAddGetHTTPEntrypoint(path string, reqFactory func(echo.Context) interface{}, invoker func(interface{}) (interface{}, error)) ServiceOption {
	return withAddHTTPEntrypoint(path, echo.GET, reqFactory, invoker)
}

// WithAddPutHTTPEntrypoint add a http put service metadata
func WithAddPutHTTPEntrypoint(path string, reqFactory func(echo.Context) interface{}, invoker func(interface{}) (interface{}, error)) ServiceOption {
	return withAddHTTPEntrypoint(path, echo.PUT, reqFactory, invoker)
}

// WithAddPostHTTPEntrypoint add a http post service metadata
func WithAddPostHTTPEntrypoint(path string, reqFactory func(echo.Context) interface{}, invoker func(interface{}) (interface{}, error)) ServiceOption {
...
func WithAddDeleteHTTPEntrypoint(path string, reqFactory func(echo.Context) interface{}, invoker func(interface{}) (interface{}, error)) ServiceOption {
	return withAddHTTPEntrypoint(path, echo.DELETE, reqFactory, invoker)
}

func withAddHTTPEntrypoint(path, method string, reqFactory func(echo.Context) interface{}, invoker func(interface{}) (interface{}, error)) ServiceOption {
